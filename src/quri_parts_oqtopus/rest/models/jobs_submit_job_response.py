...
class JobsSubmitJobResponse(BaseModel):
    """
    submit a job
    """ # noqa: E501
    job_id: StrictStr
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of JobsSubmitJobResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of JobsSubmitJobResponse from a dict"""
        if obj is None:
            return None
