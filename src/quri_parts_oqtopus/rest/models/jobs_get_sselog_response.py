...
class JobsGetSselogResponse(BaseModel):
    """
    sse log file
    """ # noqa: E501
    file: Optional[Union[StrictBytes, StrictStr]] = None
    file_name: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["file", "file_name"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of JobsGetSselogResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of JobsGetSselogResponse from a dict"""
        if obj is None:
            return None
